<template>
	<div>
		<div>
			<el-form ref="form" :model="form" label-width="140px" class="formbox">
			  <el-form-item label="停车场剩余位置" class="form">
			    <span>312</span>
			  </el-form-item>
			  <el-form-item label="停车场车位状态" class="form">
			    <el-progress :percentage="50" status="exception" style="width: 40%;padding-top: 10px;"></el-progress>
			  </el-form-item>
			 </el-form>
		</div>
